const en = {
  ...
  typefourdigits: "Please verify your account by typing 4 digit number via SMS",
  submit: "Submit",
  thankyou: "THANK YOU",
  createdsuccessfully:
    "Your loyalty membership account is created successfully",
  accountverifyshortly: "Your account ID will be notified shortly",
  userid: "User ID",
  password: "Password",
  ...
  newpwd: "New Password",
  changepwdmsg: "Password is changed successfully",
  changeLanguage: "Change Language",
  language:"Language",
  logout: "Logout",
  save: "Save",
  aboutcompany: "About Company",
  aboutloyalty: "About Loyalty Program",
  outletlocation: "Outlets Locations",
  pointavailable: "Points Available",
  availablePoint: "Available Points",
  accountInformation:"Account Information",
  hotdeal: "Hot Deals",
  inbox: "Inbox",
  surewanttologout: "Are you sure you want to logout?",
  yes: "Yes",
  cancel: "Cancel",
  thereisnoitem: "There is no items",
  agreeon : "I've read and agree on",
  signupAndaccount: "Sign up and Account",
  howdosignup: "How do I sign up for the rewards program?",
  whatareadv: "What are the advantages of becoming a rewards member?",
  needocreatenewone:
    "I already have an account. Do I need to create a new one to earn rewards?",
  whereisreward: "Where can I find all of my rewards account info?",
  willrecievepoints:
  ...
  anycost: "Does it cost anything to begin earning points?",

  eariningandredeeming: "Earning & Redeeming",
  howdoredeempoint: "How do I redeem my points?",
  howdoconvert: "How do points convert to Myanmar Kyats?",
  wherecanuse: "Will I be able to use my points/rewards in Every AtoZ store?",

  programLimit: "Program Limitations",
  howmanypointcanearn: "Is there a limit to how many points I can earn?",

  returns: "Returns",
  canretrunorder: "Can I return my order if I redeemed rewards points?",

  rewardExpection: "Reward Expiration",
  dependonpointexp:
    "Choose the answer version that best applies to your program. The answer to this question will depend on your program point expiry and validity settings",

  doPointExpired: "Do points ever expire?",
  vipProgramQts: "VIP Program Questions",

  whatisvip: "How is my VIP tier determined?",
  howknowreward: "How do I know which Rewards tier I am currently a member of?",
  howknownewtier: "How will I know when I have reached a new tier?",

  tierExp: "Tier Expiration",
  tierrule:
    "Choose the answer that best applies to your program. The answer to this question will depend on your VIP Tier Program entry thresholds and Tier term settings.",

  troubleshooting: "Troubleshooting",
  whynotearnpoint: "Why did not I earn points on my purchase?",
  getcredit:
    "I should have earned points for a purchase/incentive but I did not see my account balance change. Did I get credit?",
  whatwrong:
    "I received an error message when referring friends through the email referral box. What went wrong?",
  whatneedtogetpoint:
    "I have referred several friends but have not received any points for it. Is there something else I need to do?",

  birthdayreward: "Birthday Reward",
  howgetbdreward: "How can I get a birthday reward?",
  bdrewardnotrecieve:
    "I signed up for the Birthday Bonus but I did not receive it?",
